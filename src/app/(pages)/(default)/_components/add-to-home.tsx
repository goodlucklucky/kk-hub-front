...
export default function AddToHome() {
  return (
    ...
    >
      <div className="flex items-start justify-center text-[25px] text-[#FFF] text-center font-sans font-bold [text-shadow:1px_1px_0px_rgba(0,0,0,0.20)] w-[20px] h-full bg-[#A2A6BA] z-1 rounded-l-[20px]">
        +
      </div>
