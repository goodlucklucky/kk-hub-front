...
export default function RafflePage() {
  ...
  const [myEntries, setMyEntries] = useState([124, 312, 242, 434, 734]);
  ...
  return (
    <>
      ...
      <div className={cn("flex flex-col flex-1 justify-center items-center gap-y-5")}>
        <Image
          src={spinnerBack}
          alt="Main background"
          ...
          <div className="bg-[#F5D6B1] rounded-2xl py-6 pb-3 shadow-md border-2 border-[#A96415] flex-1 flex flex-col overflow-y-auto">
            <div className="px-3 flex flex-col items-center gap-2 border-b border-[#A96415] pb-3">
              <div className="rounded-[10px] border-2 border-[#CDAA98] bg-[#E3BEAA] shadow-[inset_0px_4px_0px_0px_rgba(0,0,0,0.20)] w-full justify-center items-center h-[154px]">
                <div className="w-full h-full flex justify-center items-center mt-1">
                  <Image src={card} alt="card" className="object-cover w-auto h-30 fixed rotate-[5deg] origin-left" />
                  <Image src={card} alt="card" className="object-cover w-auto h-30 fixed rotate-[2.5deg] origin-left" />
                  <Image src={card} alt="card" className="object-cover w-auto h-30 fixed" />
                  {startAnimation ? (
                    <CountUp
                      start={0}
                      end={123}
                    ...
                    <span className="text-[#8A6C48] text-[40px] font-bumper-sticker font-normal rotate-[-2deg] z-20 mr-4">???</span>
                  )}
                </div>
              </div>
              <span className="text-[#653F56] font-bumper-sticker text-lg mt-1">UNTIL NEXT DRAW</span>
            ...
            <div className="flex flex-col gap-3 w-full px-3 pt-2">
              <span className="text-[#8F6E75] font-made-in-heaven text-sm font-bold text-center">
                Enter the Daily Draw for a chance to win USDT, Spins, Koko Chests, and more!
              </span>
              <div className="flex flex-col gap-2">
                ...
                >
                  ...
                  <span className='text-white text-sm font-bold py-1'>Claim Tickets</span>
                </Button>
                <div className="flex justify-center gap-1 bg-[#D1B69F] rounded-[6px] p-1 py-1.5">
